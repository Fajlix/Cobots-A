...
if __name__ == '__main__':
    ...
    ros_trans = transform_manager.lookup_ros_transform('base_link', 'rg2_base_link')
    print('-'*80)
    print(ros_trans)
    print(type(ros_trans))

    numpy_trans = transform_manager.lookup_numpy_transform('base_link', 'rg2_base_link')
    print('-'*80)
    print(numpy_trans)
    print(type(numpy_trans))
    panda_link8_pose = PoseStamped()
    panda_link8_pose.header.frame_id = "rg2_base_link"
